...
<body>
    ...
    <form action="" method="post" onsubmit="return validateForm();">
        ...
        <input type="number" id="weight" name="weight" value="<?php echo isset($weight) ? $weight : ''; ?>" required><br>

        <label for="height">Height (m):</label>
        <input type="number" id="height" name="height" value="<?php echo isset($height) ? $height : ''; ?>" required><br>
